"""
Django settings for alx_travel_app_0x03 project.
...
SECRET_KEY = 'django-insecure-6m2^)25)z3g01z8l779m5y*omsg+zh_jt=(&mc8w6s^j$*v44_'
...
INSTALLED_APPS = [
    ...
    "listings",
    "django_celery_results",  # optional if you want task tracking
]
